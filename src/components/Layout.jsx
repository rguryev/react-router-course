...
// Стилизуем активные линки 3-мя разными способами.
// 8. Если хотим, чтобы выделялась выбранная (активная) ссылка - то вместо Link оборачиваем ссылку в NavLink. NavLink автоматически на выбранный элемент вешает класс .active, поэтому в css просто задаем стили на этот класс. Оставим этот способ в ссылке Home.
